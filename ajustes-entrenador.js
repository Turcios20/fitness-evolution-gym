...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const themeToggle = document.getElementById("trainerThemeToggle");
  const saveThemeButton = document.getElementById("btnSaveTrainerTheme");
  const changePasswordButton = document.getElementById("btnChangeTrainerPassword");
  const messageBox = document.getElementById("trainerPasswordMsg");

  const passwordFields = {
    current: document.getElementById("trainerCurrentPassword"),
    next: document.getElementById("trainerNewPassword"),
    confirm: document.getElementById("trainerConfirmPassword")
  };

  const passwordErrors = {
    current: document.getElementById("trainerErrCurrentPassword"),
    next: document.getElementById("trainerErrNewPassword"),
    confirm: document.getElementById("trainerErrConfirmPassword")
  };
  ...
  async function loadUserThemePreference() {
    try {
      ...
      applyThemeToPage(window.GymApp.getTheme());
      console.error("No se pudo cargar el tema del entrenador:", error);
    }
  }
